    ...
    <div className="flex flex-col items-center gap-4">
      ...
      {preview ? (
        ...
        <button
          ...
          disabled={isLoading}
          className="flex h-48 w-full max-w-sm flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 transition-colors hover:border-green-400 hover:bg-green-50"
        >
